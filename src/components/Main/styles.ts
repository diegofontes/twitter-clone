...
export const Container = styled.div`
        ...
        width: min(601px, 100%); /* pega o valor minimo entre o primeiro e o segundo valor  */
...
export const BackIcon = styled(ArrowLeft)`
        ...
        fill: var(--twitter); /* propriedade em CSS é para preencher a cor de uma forma SVG. */
`;
...
export const BottomMenu = styled.div`
    position: fixed; /* Fixa minha posicao */
    bottom: 0; 
    left: 0;
    z-index: 2;
